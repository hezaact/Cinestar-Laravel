...
<head>
    ...
    <link rel="icon" href="{{ asset('img/varios/favicon.ico') }}">
...
<header>
    ...
    <nav class="menu">
        ...
        <ul class="menu-principal">
            <li class="menu-item"><a href="{{ route('peliculas', '1') }}">Cartelera</a></li>
            <li class="menu-item"><a href="{{route('peliculas','2')}}">Próximos estrenos</a></li>
            <li class="menu-item"><a href="http://www.cinestar.com.pe/starcard">Star Card</a></li>
            <li class="menu-item"><a href="{{route('Nuestros-Cines')}}">Nuestros Cines</a></li>
